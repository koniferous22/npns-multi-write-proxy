...
export class ActivityByUserIdInput {
  ...
  @TypeGraphQL.Field(type => _Any, { nullable: true })
...
export class Challenge extends AbstractPost {
  ...
  @TypeGraphQL.Field(type => SubmissionConnectionConnection)
  submissions!: FixDecorator<SubmissionConnectionConnection>;
};


@TypeGraphQL.ArgsType()
export class ChallengeSubmissionsArgs {

  @TypeGraphQL.Field(type => ConnectionInput)
  input!: FixDecorator<ConnectionInput>;
};
...
@TypeGraphQL.ArgsType()
export class SubmissionRepliesArgs {
...
@TypeGraphQL.ObjectType()
export class SubmissionConnectionConnection {
  __typename?: 'SubmissionConnectionConnection';

  @TypeGraphQL.Field(type => [SubmissionConnectionEdge])
  edges!: Array<SubmissionConnectionEdge>;

  @TypeGraphQL.Field(type => SubmissionConnectionPageInfo)
  pageInfo!: FixDecorator<SubmissionConnectionPageInfo>;
};

@TypeGraphQL.ObjectType()
export class SubmissionConnectionEdge {
  __typename?: 'SubmissionConnectionEdge';

  @TypeGraphQL.Field(type => SubmissionCursor)
  cursor!: FixDecorator<SubmissionCursor>;

  @TypeGraphQL.Field(type => Submission)
  node!: FixDecorator<Submission>;
};

@TypeGraphQL.ObjectType()
export class SubmissionConnectionPageInfo {
